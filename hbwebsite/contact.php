...
<head>
    ...
    <title>Mystical Suites - CONTACT</title>
        ...
        <div class="row">
            <div class="col-lg-6 col-md-6 mb-5 px-4">
                <div class="bg-white rounded shadow p-4">
                    <iframe class="w-100 rounded" height="320" src="<?php echo $contact_r['iframe'] ?>" width="600"
                ...
                <div class="bg-white rounded shadow p-4">
                    <form method="POST">
                        ...
                        <div class="mt-3">
                            ...
                            <textarea name="message" required class="form-control shodow-none" rows="5"
