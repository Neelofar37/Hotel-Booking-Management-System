...
<body class="bg-light">
    ...
    <div class="container-fluid" id="main-content">
        <div class="row">
            <div class="col-lg-10 ms-custom p-4 overflow-hidden">
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <textarea name="site_about" id="site_about_inp" class="form-control shodow-none"
                ...
                <div class="card border-0 shadow-sm mb-4">
                    <div class="card-body">
                        <div class="d-flex align-items-center justify-content-between mb-3">
                            <h5 class="card-title m-0">Maintenance Mode</h5>
                        ...
                        <p class="card-text">
                            Scheduled downtime: temporarily disable room reservations for users.
                        </p>
                    </div>
                </div>
                ...
                <div class="card border-0 shadow-sm mb-4">
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="mb-4">
                                    <h6 class="card-subtitle mb-1 fw-bold">Social Media Profiles</h6>
                                    <p class="card-text mb-1">
                ...
                <div class="modal fade" id="team-s" data-bs-backdrop="static" data-bs-keyboard="true" tabindex="-1"
                    ...
                    <div class="modal-dialog">
                        <form id="team_s_form">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title">Recruit Team Members</h5>
                                </div>
                                <div class="modal-body">
                                    <div class="mb-3">
